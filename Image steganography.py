...
class Stegno:
    ...
    def main(self,root):
        ...
        title = Label(f,text='INNOVATE 2K24  \n Image Steganography')
        title.config(font=("Arial",33,"bold"))
        title.grid(pady=50)

        b_encode = Button(f,text="Encode",command= lambda :self.frame1_encode(f),fg='blue',font="Arial",padx=14)
        b_encode.config(font=('courier',14))
        b_decode = Button(f, text="Decode",padx=14,command=lambda :self.frame1_decode(f),fg='blue',font="Arial")
    ...
    def frame1_decode(self,f):
        f.destroy()
        d_f2 = Frame(root)
        label_art = Label(d_f2, text="INNOVATE 2K24")
    ...
    def frame1_encode(self,f):
        ...
        label_art = Label(f2, text='INNOVATE 2K24')
        label_art.config(font=('Helvetica',33))
        label_art.grid(row =1,pady=50)
